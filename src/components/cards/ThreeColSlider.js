...
export default () => {
  ...
  const cards = [
    {
      ...
      locationText: "Гүйцэтгэх захирал",
      pricingText: "",
      rating: "",
    },
    {
      ...
      title: "Б.Ариунзаяа",
      description: "#Мэдээллийн сан бүрдүүлэх, #төрөлжсөн зураг, #зүсэлт бүдүүвч, #график, #боловсруулах, #агаар сансрын зураг боловсруулах",
      locationText: "Зөвлөх",
      pricingText: "",
    ...
    },
    {
      ...
      title: "Д.Энхмаа",
      description: "#Гидрогеологич 1:25000-ны масщтабтай зураглал зохиох, #гидрогеологийн бүх түвшний судалгаа",
      locationText: "Гидрогеологич",
      pricingText: "",
    ...
    },
    {
      ...
      title: "С.Дэлгэрсанаа",
      description: "#Газарзүйн мэдээллийн сан үүсгэх, #дата бааз бүрдүүлэх болон бусад",
      locationText: "Геологич",
      pricingText: "",
    },
  ]
  ...
  return (
    <Container>
      <Content>
        <HeadingWithControl>
          <Heading>Судалгааны баг</Heading>
          <Controls>
        ...
        <CardSlider ref={setSliderRef} {...sliderSettings}>
          {cards.map((card, index) => (
            <Card key={index}>
              ...
              <PrimaryButton>Дэлгэрэнгүй</PrimaryButton>
            </Card>
          ))}
        </CardSlider>
      </Content>
