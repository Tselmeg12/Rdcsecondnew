...
export default ({
  subheading = "МЭДЭЭ МЭДЭЭЛЭЛ:",
  headingHtmlComponent = (
    <>
      Хамтран ажилласанд  <span tw="text-primary-500">баярлалаа.</span>
    </>
  ),
  description = "Асуудлыг шийдэх гаргалгааг олсноор цаашид улам хөгжин өсөн тэмүүлнэ.",
  linkText = "Цааш үзэх",
  cardLinkText = "Дэлгэрэнгүй",
  textOnLeft = false
}) => {
  const cards = [
    {
      ...
      company: "Эрдэнэс",
      type: "Судалгаа",
      title: "ЭР геэкологи-2019 төслийн багийнхан хээрийн ажил",
      durationText: "180 хоног",
      locationText: "Эрдэнэт, Монгол"
    },
    {
      imageSrc:
      ...
      durationText: "10 хоног",
      locationText: "Таньшань, Хятад"
    }
  ];
  return (
    <Container>
